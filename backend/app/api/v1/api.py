...
from app.api.v1.endpoints import health, cities, recommendations, cost_estimator, bank_recommendations, checklist
...
api_router.include_router(checklist.router, prefix="/checklist")
